...
;
TYPE:       jsr     ISNUM           ; Check if first char of args is numeric
...
;
BEGINOF:    jsr     GETCHANN        ; Get channel from command line
...
; ARGUMENTS:    <channel> = channel number, previously assigned to a file
;
ENDOF:      jsr     GETCHANN        ; Get channel from command line
